  ...
  with tf.Graph().as_default():
    ...
    def network_fn(main, side):
      ...
      with slim.arg_scope(arg_scope):
        return func(main, side, num_classes=(dataset.num_classes - FLAGS.labels_offset), is_training=False)
